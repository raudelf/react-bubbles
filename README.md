...
- [ ] Explain what a token is used for.
  ...
  A token is basically used to authenticate the user to make sure that only authorized users can see specific data or pages.

- [ ] What steps can you take in your web apps to keep your data secure?

  One step you can take to keep your data secure is making PrivateRoutes so that only authorized users can access certain web pages.

  Another one would be encrypting users credentials when logging in so that their credentials aren't easily readable and be compromised.

- [ ] Describe how web servers work.

  Web servers store data that can be displayed to users. Users can request access to this data with URLs.

- [ ] Which HTTP methods can be mapped to the CRUD acronym that we use when interfacing with APIs/Servers.

  Create = .post, Retrieve = .get, Update = .put, amd Delete = .delete
